          ...
          <div className="flex justify-between items-start">
            <div className="max-w-2xl">
              ...
              <p className="text-lg text-orange-100 mb-6">
                Semua testimoni dari users dengan mudah
              </p>
            </div>
        ...
        {testimonials.length > 0 ? (
                  ...
                  <div className="flex items-start mb-4">
                    {testimonial.image_url ? (
                      <img 
                        ...
                        className="w-14 h-14 rounded-full object-cover mr-4 ring-4 ring-orange-100 group-hover:ring-orange-200 transition-all" 
                      />
                    ) : (
                      <div className="w-14 h-14 rounded-full bg-gradient-to-br from-orange-400 to-amber-500 flex items-center justify-center mr-4 ring-4 ring-orange-100 group-hover:ring-orange-200 transition-all shadow-lg">
                  ...
                  {testimonial.user_username && (
                    <div className="mb-4 pb-4 border-b border-gray-100">
                      <p className="text-xs text-gray-500 inline-flex items-center">
                        ...
                        Dibuat oleh: <span className="font-semibold ml-1">{testimonial.user_username}</span>
                      </p>
                    </div>
                  )}
          ...
          <div className="bg-white rounded-2xl shadow-lg p-12 text-center scroll-animate">
            <div className="max-w-md mx-auto">
              ...
              <p className="text-gray-600 mb-6">Mulai dengan menambahkan testimoni pertama</p>
              <button
                onClick={openAddModal}
      ...
      {showModal && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4 animate-fade-in" onClick={() => { setShowModal(false); resetForm(); }}>
          <div className="bg-white rounded-2xl max-w-md w-full max-h-[90vh] overflow-y-auto shadow-2xl animate-scale-in" onClick={(e) => e.stopPropagation()}>
            <div className="bg-gradient-to-r from-orange-600 to-amber-700 p-6 text-white rounded-t-2xl sticky top-0 z-10">
