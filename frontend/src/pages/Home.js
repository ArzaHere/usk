    ...
    <div className="overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-gradient-to-br from-blue-50 to-purple-50 rounded-2xl p-8 md:p-12 shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 scroll-animate">
              ...
              {/* Stats */}
              <div className="grid grid-cols-3 gap-4 mt-8 pt-8 border-t border-blue-200">
                <div className="text-center scroll-animate">
                  <div className="text-3xl font-bold text-blue-600 mb-1 counter" data-target="100">0</div>
                  <div className="text-sm text-gray-600">Klien Puas</div>
                </div>
                <div className="text-center scroll-animate">
                  <div className="text-3xl font-bold text-purple-600 mb-1 counter" data-target="500">0</div>
                  <div className="text-sm text-gray-600">Proyek Selesai</div>
                </div>
                <div className="text-center scroll-animate">
                  <div className="text-3xl font-bold text-pink-600 mb-1 counter" data-target="10">0</div>
      ...
      <section className="py-20 bg-gradient-to-br from-gray-50 to-blue-50 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-16 scroll-animate">
            <span className="text-blue-600 font-semibold text-sm uppercase tracking-wider">Layanan Kami</span>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16 scroll-animate">
            <span className="text-blue-600 font-semibold text-sm uppercase tracking-wider">Blog & Artikel</span>
            <h2 className="text-4xl md:text-5xl font-bold mt-2 mb-4 bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">
              Wawasan & Artikel Teknologi
            </h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
              Temukan informasi terkini seputar teknologi dan transformasi digital
            </p>
          </div>
