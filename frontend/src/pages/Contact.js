...
const Contact = () => {
  ...
  const contactInfo = [
    ...
    },
    {
      id: 3,
      title: 'Email',
      value: company?.email || 'info@perusahaan.com',
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16 animate-fade-in">
          ...
          <p className="text-lg text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed animate-slide-up">
            Hubungi kami untuk informasi lebih lanjut, konsultasi, atau kerjasama. Tim kami siap membantu Anda!
          </p>
          ...
          <div className="space-y-8 animate-fade-in-left">
              ...
              <div className="space-y-6">
                {contactInfo.map((info, index) => (
                  ...
                  >
                    ...
                    <div className={`absolute top-0 right-0 w-32 h-32 bg-gradient-to-br ${info.bgColor} opacity-0 group-hover:opacity-10 rounded-full transform translate-x-16 -translate-y-16 transition-opacity duration-500`}></div>
                    
                    <div className="flex items-start relative z-10">
                      <div className={`${info.iconBg} p-4 rounded-xl mr-5 ${info.iconColor} group-hover:scale-110 transition-transform duration-500 shadow-md`}>
                        {info.icon}
                      </div>
                      <div className="flex-1">
                        ...
                        {info.subValue && (
                          <p className="text-gray-600 leading-relaxed">{info.subValue}</p>
                        )}
                      </div>
                    </div>

                    {/* Bottom accent line */}
                    <div className={`absolute bottom-0 left-0 right-0 h-1 bg-gradient-to-r ${info.bgColor} transform scale-x-0 group-hover:scale-x-100 transition-transform duration-500 origin-left`}></div>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 animate-fade-in-up" style={{ animationDelay: '400ms' }}>
              ...
              <p className="text-sm text-gray-500 mt-6">
                Ikuti media sosial kami untuk mendapatkan update terbaru, tips, dan informasi menarik lainnya!
              </p>
            </div>
          </div>
          ...
          <div className="animate-fade-in-right">
            <div className="bg-white rounded-2xl shadow-2xl p-8 relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="text-gray-600 mb-8">Isi formulir di bawah ini dan kami akan menghubungi Anda segera</p>
                ...
                {submitted && (
                  <div className="bg-gradient-to-r from-green-50 to-emerald-50 border-l-4 border-green-500 text-green-700 px-6 py-4 rounded-lg mb-6 shadow-md animate-slide-down flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-sm">Terima kasih telah menghubungi kami. Kami akan segera merespons pesan Anda.</p>
                    </div>
                  </div>
                )}
        ...
        {/* Map Section */}
        <div className="max-w-7xl mx-auto animate-fade-in-up" style={{ animationDelay: '600ms' }}>
          <div className="text-center mb-8">
            <h2 className="text-3xl font-bold text-gray-800 mb-4">Lokasi Kami</h2>
            <p className="text-gray-600">Kunjungi kantor kami atau temui kami untuk diskusi lebih lanjut</p>
          </div>
          <div className="bg-white rounded-2xl overflow-hidden shadow-2xl h-96 flex items-center justify-center relative group">
            <div className="absolute inset-0 bg-gradient-to-br from-blue-100 via-indigo-100 to-purple-100">
              ...
              <div className="absolute inset-0 opacity-20">
                ...
                <div className="absolute bottom-1/4 right-1/4 w-40 h-40 bg-purple-300 rounded-full blur-3xl"></div>
              </div>
            </div>
            <div className="relative z-10 text-center">
              <div className="w-20 h-20 mx-auto mb-4 bg-white rounded-full flex items-center justify-center shadow-xl group-hover:scale-110 transition-transform duration-500">
                <svg className="w-10 h-10 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                </svg>
              </div>
              <p className="text-gray-600 text-lg font-medium">Peta interaktif akan ditampilkan di sini</p>
              <p className="text-gray-500 text-sm mt-2">Integrasi dengan Google Maps atau Mapbox</p>
            </div>
          </div>
        </div>
      </div>
