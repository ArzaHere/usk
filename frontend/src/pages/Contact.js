  ...
  return (
    <div className="py-12">
      <div className="container mx-auto px-4">
        <h1 className="text-4xl font-bold text-center mb-4">Kontak Kami</h1>
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">{company?.address || 'Jl. Contoh No. 123, Jakarta, Indonesia'}</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">{company?.email || 'info@perusahaan.com'}</p>
                </div>
              </div>
